...
class SSEManager {
    ...
    public broadcastToSession(sessionId: string, data: any): void {
        ...
        if (subscribedClients.length === 0) {
            ...
            if (eventType === "assistant_message" || eventType === "tool_use_message" || eventType === "turn_complete" || eventType === "ask_user_question" || eventType === "loading_start" || eventType === "user_message" || eventType === "permission_request" || eventType === "permission_decided") {
